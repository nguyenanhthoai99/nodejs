...
(() => {
    ...
    (qe = p({}, e))[g] = p(
        p(p(p({}, { 'fa-duotone': 'duotone' }), e[g]), n),
        r,
    );
    var ht = d(qe),
        gt =
            ...
            e = Wt(
                ...
                function (t, e) {
                    ...
                    return (
                        'far' !== a || i || (a = 'fas'),
                        'string' == typeof n &&
                            (t.names[n] = { prefix: a, iconName: r }),
                        'number' == typeof n &&
                            (t.unicodes[n.toString(16)] = {
                                prefix: a,
                                iconName: r,
                            }),
                        t
                          ...
                          : Array.isArray(t) && 2 === t.length
                            ...
                            : 'string' == typeof t &&
                              ...
                              ? {
                                    ...
                                    iconName:
                                        E(n.prefix, n.iconName) || n.iconName,
                                }
                              : 'string' == typeof t
                    ...
                    ((s.transform =
                        ...
                        (r =
                            (r =
                                ...
                                'scale('
                                    .concat(
                                        (o.size / P) * (o.flipX ? -1 : 1),
                                        ', ',
                                    )
                                    .concat(
                                        (o.size / P) * (o.flipY ? -1 : 1),
                                        ') ',
                    ...
                    n.parentNode.insertBefore(
                        (function e(n, t) {
                            ...
                            return 'string' == typeof n
                                ? v.createTextNode(n)
                                : ((a = i(n.tag)),
                                  Object.keys(n.attributes || []).forEach(
                                      function (t) {
    ...
    function Be(t) {
        var e =
            'nest' === j.autoReplaceSvg ? Je(t, { styleParser: !1 }) : Je(t);
                    ...
                    t.generateAbstractMask = function (t) {
                        var e = t.children,
                            ...
                            l =
                                ...
                                (c = 'scale('
                                    .concat(
                                        (s.size / 16) * (s.flipX ? -1 : 1),
                                        ', ',
                                    )
                                    .concat(
                                        (s.size / 16) * (s.flipY ? -1 : 1),
                                        ') ',
                                    )),
